...
const GenerateImages = () => {
    const imageStyle = [
        "Realistic","Ghibli style", "Animie style", "Cartoon style", "Fantasy style", "Realistic style", "3D style", "Portrait style"
    ];
                    ...
                    {imageStyle.map((item) => (
                        <span
                            ...
                            className={`text-xs px-4 py-1 border rounded-full cursor-pointer ${
                                selectedStyle === item
                                    ? "bg-purple-50 text-green-700 border-blue-300"
            ...
            <div className="w-full md:w-1/2 p-4 bg-white rounded-lg flex flex-col border border-gray-200 min-h-96">
                ...
                <div className="flex-1 flex justify-center items-center">
                    <div className="text-sm flex flex-col items-center gap-5 text-gray-400">
                        ...
                        <p>
                            Enter a topic and click "Generate image" to get
                            started
                        </p>
                    </div>
                </div>
